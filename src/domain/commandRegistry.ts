...
export const STATIC_NAVIGATION_COMMANDS: CommandItem[] = [
  ...
  },
  {
    id: 'nav-maintenance',
    label: 'Cura del PC',
    subtitle: 'Registro interventi, diagnostica di sistema Windows e tuning journal',
    category: 'navigation',
    keywords: ['cura', 'cura del pc', 'manutenzione', 'maintenance', 'pulizia', 'pasta termica', 'windows', 'tuning', 'salute'],
  ...
  // 2. Deep Navigation (Sub-Tabs)
  {
    ...
    keywords: ['registro', 'interventi', 'pasta termica', 'manutenzione', 'cura', 'log', 'pulizia', 'scadenze'],
    target: { section: 'maintenance', subTab: 'registro' },
  },
  {
    id: 'deep-maintenance-windows',
    label: 'Sistema Windows',
    subtitle: 'Diagnostica rapida, TRIM SSD, verifica integrità SFC/CHKDSK e pulizia',
    category: 'deep-navigation',
    keywords: ['sistema', 'windows', 'tools', 'strumenti', 'scan', 'diagnostica', 'trim', 'sfc', 'chkdsk', 'cestino', 'ibernazione', 'pulizia disco'],
    target: { section: 'maintenance', subTab: 'windows' },
  },
  {
